...
def get_parser():
    ...
    parser.add_argument("--vlm_backend", type=str, default="llava")
    parser.add_argument("--vlm_model_path", type=str, default=None)
    parser.add_argument("--vlm_conv_mode", type=str, default="default")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for i, idx_det in enumerate(idx_sort[:5]):
            ...
            image_tensor = chat.preprocess_image(image_crop)
            image_feature = chat.encode_image(image_tensor)
