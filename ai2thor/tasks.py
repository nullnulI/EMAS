...
def clean():
    import mwl.EMAS.ai2thor.scripts.update_private
    ...
    mwl.EMAS.ai2thor.scripts.update_private.private_repo_url = (
    ...
    shutil.rmtree(mwl.EMAS.ai2thor.scripts.update_private.private_dir, ignore_errors=True)
    mwl.EMAS.ai2thor.scripts.update_private.checkout_branch()
