...
from mwl.EMAS.ai2thor.arm_test.base import standard_pose, execute_actions
import mwl.EMAS.ai2thor.arm_test.base
...
event = mwl.EMAS.ai2thor.arm_test.base.controller.step(
    "MoveArmBase",
